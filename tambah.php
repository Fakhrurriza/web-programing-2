...
<a href="index.php">Kembali</a>
	...
	if(isset($_GET['nama'])){
		if($_GET['nama'] == ""){
			echo "<h4 style='color:red'>nama tidak boleh kosong bro !</h4>";
		}
    }
    if(isset($_GET['email'])){
		if($_GET['email'] == ""){
			echo "<h4 style='color:red'>email tidak boleh kosong bro !</h4>";
		}
    }
    if(isset($_GET['usrname'])){
		if($_GET['usrname'] == ""){
			echo "<h4 style='color:red'>username tidak boleh kosong bro !</h4>";
		}
    }
    if(isset($_GET['pwd'])){
		if($_GET['pwd'] == ""){
			echo "<h4 style='color:red'>password tidak boleh kosong bro !</h4>";
		}
	}
	?>
